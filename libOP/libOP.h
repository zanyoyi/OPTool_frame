...
OP_ENTRY OP1BMap[256] = {
    ...
    //# 0x50 - 0x5f
    {0x50,0x00,0 | PF_Valid," PUSH rAX/r08 (d64)"},
    {0x51,0x00,0 | PF_Valid," PUSH rCX/r09 (d64)"},
    ...
    {0x58,0x00,0 | PF_Valid," POP rAX/r08 (d64)"},
    {0x59,0x00,0 | PF_Valid," POP rCX/r09 (d64)"},
    ...
    //# 0x80 - 0x8f
    {0x80,0x80,0 | PF_Valid," Grp1 Eb,Ib (1A)"},
    {0x81,0x80,0 | PF_Valid," Grp1 Ev,Iz (1A)"},
    {0x82,0x80,0 | PF_Valid," Grp1 Eb,Ib (1A),(i64)"},
    {0x83,0x80,0 | PF_Valid," Grp1 Ev,Ib (1A)"},
    ...
    {0x8d,0x40,0 | PF_Valid," LEA Gv,M"},
    {0x8e,0x00,0 | PF_Valid," MOV Sw,Ew"},
    {0x8f,0x80,0 | PF_Valid," Grp1A (1A) | POP Ev (d64)"},
    //# 0x90 - 0x9f
    {0x90,0x00,0," NOP | PAUSE (F3) | XCHG rAX,rAX/r08"},
    {0x91,0x00,0 | PF_Valid," XCHG rAX,rCX/r09"},
    {0x92,0x00,0 | PF_Valid," XCHG rAX,rDX/r10"},
    {0x93,0x00,0 | PF_Valid," XCHG rAX,rBX/r11"},
    {0x94,0x00,0 | PF_Valid," XCHG rAX,rSP/r12"},
    {0x95,0x00,0 | PF_Valid," XCHG rAX,rBP/r13"},
    {0x96,0x00,0 | PF_Valid," XCHG rAX,rSI/r14"},
    ...
    //# 0xb0 - 0xbf
    {0xb0,0x00,0 | PF_Valid," MOV AL/R08L,Ib"},
    {0xb1,0x00,0 | PF_Valid," MOV CL/R09L,Ib"},
    ...
    {0xb8,0x00,0 | PF_Valid," MOV rAX/r08,Iv"},
    {0xb9,0x00,0 | PF_Valid," MOV rCX/r09,Iv"},
    ...
    {0xc7,0x80,0 | PF_Valid," Grp11B Ev,Iz (1A)"},
    ...
    //# 0xd0 - 0xdf
    {0xd0,0x80,0 | PF_Valid," Grp2 Eb,1 (1A)"},
    {0xd1,0x80,0 | PF_Valid," Grp2 Ev,1 (1A)"},
    {0xd2,0x80,0 | PF_Valid," Grp2 Eb,CL (1A)"},
    {0xd3,0x80,0 | PF_Valid," Grp2 Ev,CL (1A)"},
    ...
    {0xf6,0x80,0 | PF_Valid," Grp3_1 Eb (1A)"},
    {0xf7,0x80,0 | PF_Valid," Grp3_2 Ev (1A)"},
    ...
    {0xfe,0x80,0 | PF_Valid," Grp4 (1A)"},
    {0xff,0x80,0 | PF_Valid," Grp5 (1A)"},
};
OP_ENTRY OP2BMap[256] = {
    //# 0x0f 0x00-0x0f
    {0x00,0x80,0 | PF_Valid," Grp6 (1A)"},
    {0x01,0x80,0 | PF_Valid," Grp7 (1A)"},
    ...
    {0x0d,0x80,0 | PF_Valid," GrpP"},
    {0x0e,0x00,0 | PF_Valid," FEMMS"},
    //# 3DNow! uses the last imm byte as opcode extension.
    {0x0f,0x00,0," 3DNow! Pq,Qq,Ib"},
    //# 0x0f 0x10-0x1f
    ...
    {0x1c,0x80,0 | PF_Valid," Grp20 (1A),(1C)"},
    {0x1d,0x00,0 | PF_Valid,NULL},
    {0x1e,0x80,0 | PF_Valid," Grp21 (1A)"},
    {0x1f,0x00,0 | PF_Valid," NOP Ev"},
    //# 0x0f 0x20-0x2f
    {0x20,0x20,0 | PF_Valid," MOV Rd,Cd"},
    {0x21,0x20,0 | PF_Valid," MOV Rd,Dd"},
    {0x22,0x20,0 | PF_Valid," MOV Cd,Rd"},
    {0x23,0x20,0 | PF_Valid," MOV Dd,Rd"},
    ...
    {0x33,0x00,0 | PF_Valid | PF_Uncertain," RDPMC"},
    {0x34,0x00,0 | PF_Valid," SYSENTER"},
    {0x35,0x00,0 | PF_Valid," SYSEXIT"},
    {0x36,0x00,0 | PF_Valid,NULL},
    {0x37,0x00,0," GETSEC"},
    {0x38,0x80,0 | PF_Valid," escape # 3-byte escape 1"},
    {0x39,0x00,0 | PF_Valid,NULL},
    {0x3a,0x80,0 | PF_Valid," escape # 3-byte escape 2"},
    ...
    {0x71,0x80,0 | PF_Valid," Grp12 (1A)"},
    {0x72,0x80,0 | PF_Valid," Grp13 (1A)"},
    {0x73,0x80,0 | PF_Valid," Grp14 (1A)"},
    ...
    {0xc3,0x40,0 | PF_Valid," movnti My,Gy"},
    ...
    {0xc7,0x80,0 | PF_Valid," Grp9 (1A)"},
    {0xc8,0x00,0 | PF_Valid," BSWAP RAX/EAX/R08/R08D"},
    {0xc9,0x00,0 | PF_Valid," BSWAP RCX/ECX/R09/R09D"},
    ...
    //# 0x0f 0xf0-0xff
    {0xf0,0x40,0 | PF_Valid | PF_REPNE," vlddqu Vx,Mx (F2)"},
...
OP_ENTRY OP3BMap_0F38[256] = {
    ...
    {0x1B,0x40,0 | PF_Operand," vbroadcastf32x8/64x4 Vqq,Mdq (66),(ev)"},
    ...
    {0x2E,0x40,0 | PF_Operand," vmaskmovps Mx,Hx,Vx (66),(v)"},
    {0x2F,0x40,0 | PF_Operand," vmaskmovpd Mx,Hx,Vx (66),(v)"},
    //# 0x0f 0x38 0x30-0x3f
    ...
    {0x37,0x00,0 | PF_Operand," vpcmpgtq Vx,Hx,Wx (66),(v1)"},
    ...
    {0x5B,0x40,0 | PF_Operand," vbroadcasti32x8/64x4 Vqq,Mdq (66),(ev)"},
    //# Skip 0x5c-0x61
    ...
    {0x7A,0x20,0 | PF_Operand," vpbroadcastb Vx,Rv (66),(ev)"},
    {0x7B,0x20,0 | PF_Operand," vpbroadcastw Vx,Rv (66),(ev)"},
    {0x7C,0x20,0 | PF_Operand," vpbroadcastd/q Vx,Rv (66),(ev)"},
    ...
    {0x80,0x40,0 | PF_Operand," INVEPT Gy,Mdq (66)"},
    {0x81,0x40,0 | PF_Operand," INVVPID Gy,Mdq (66)"},
    {0x82,0x40,0 | PF_Valid | PF_Uncertain | PF_Operand," INVPCID Gy,Mdq (66)"},
    ...
    {0x8C,0x40,0 | PF_Operand," vpmaskmovd/q Vx,Hx,Mx (66),(v)"},
    {0x8D,0x00,0 | PF_Operand," vpermb/w Vx,Hx,Wx (66),(ev)"},
    {0x8E,0x40,0 | PF_Operand," vpmaskmovd/q Mx,Vx,Hx (66),(v)"},
    ...
    {0xC6,0x80,0 | PF_Valid," Grp18 (1A)"},
    {0xC7,0x80,0 | PF_Valid," Grp19 (1A)"},
    {0xC8,0x00,0," sha1nexte Vdq,Wdq | vexp2ps/d Vx,Wx (66),(ev)"},
    {0xC9,0x00,0," sha1msg1 Vdq,Wdq"},
    ...
    {0xCF,0x00,0 | PF_Operand," vgf2p8mulb Vx,Wx (66)"},
    ...
    {0xDB,0x00,0 | PF_Operand," vaesimc Vdq,Wdq (66),(v1)"},
    {0xDC,0x00,0 | PF_Operand," vaesenc Vx,Hx,Wx (66)"},
    {0xDD,0x00,0 | PF_Operand," vaesenclast Vx,Hx,Wx (66)"},
    {0xDE,0x00,0 | PF_Operand," vaesdec Vx,Hx,Wx (66)"},
    {0xDF,0x00,0 | PF_Operand," vaesdeclast Vx,Hx,Wx (66)"},
...
OP_ENTRY OP3BMap_0F3A[256] = {
    //# 0x0f 0x3a 0x00-0xff
    {0x00,0x00,0 | PF_Operand," vpermq Vqq,Wqq,Ib (66),(v)"},
    {0x01,0x00,0 | PF_Operand," vpermpd Vqq,Wqq,Ib (66),(v)"},
    {0x02,0x00,0 | PF_Operand," vpblendd Vx,Hx,Wx,Ib (66),(v)"},
    {0x03,0x00,0 | PF_Operand," valignd/q Vx,Hx,Wx,Ib (66),(ev)"},
    {0x04,0x00,0 | PF_Operand," vpermilps Vx,Wx,Ib (66),(v)"},
    {0x05,0x00,0 | PF_Operand," vpermilpd Vx,Wx,Ib (66),(v)"},
    {0x06,0x00,0 | PF_Operand," vperm2f128 Vqq,Hqq,Wqq,Ib (66),(v)"},
    ...
    {0x1A,0x00,0 | PF_Operand," vinsertf32x8/64x4 Vqq,Hqq,Wqq,Ib (66),(ev)"},
    {0x1B,0x00,0 | PF_Operand," vextractf32x8/64x4 Wdq,Vqq,Ib (66),(ev)"},
    {0x1C,0x00,0 | PF_Valid,NULL},
    {0x1D,0x00,0 | PF_Operand," vcvtps2ph Wx,Vx,Ib (66),(v)"},
    {0x1E,0x00,0 | PF_Operand," vpcmpud/q Vk,Hd,Wd,Ib (66),(ev)"},
    {0x1F,0x00,0 | PF_Operand," vpcmpd/q Vk,Hd,Wd,Ib (66),(ev)"},
    ...
    {0x23,0x00,0 | PF_Operand," vshuff32x4/64x2 Vx,Hx,Wx,Ib (66),(ev)"},
    {0x24,0x00,0 | PF_Valid,NULL},
    {0x25,0x00,0 | PF_Operand," vpternlogd/q Vx,Hx,Wx,Ib (66),(ev)"},
    {0x26,0x00,0 | PF_Operand," vgetmantps/d Vx,Wx,Ib (66),(ev)"},
    {0x27,0x00,0 | PF_Operand," vgetmantss/d Vx,Hx,Wx,Ib (66),(ev)"},
    ...
    {0x30,0x20,0 | PF_Operand," kshiftrb/w Vk,Uk,Ib (66),(v)"},
    {0x31,0x20,0 | PF_Operand," kshiftrd/q Vk,Uk,Ib (66),(v)"},
    {0x32,0x20,0 | PF_Operand," kshiftlb/w Vk,Uk,Ib (66),(v)"},
    {0x33,0x20,0 | PF_Operand," kshiftld/q Vk,Uk,Ib (66),(v)"},
    ...
    {0x3A,0x00,0 | PF_Operand," vinserti32x8/64x4 Vqq,Hqq,Wqq,Ib (66),(ev)"},
    {0x3B,0x00,0 | PF_Operand," vextracti32x8/64x4 Wdq,Vqq,Ib (66),(ev)"},
    {0x3C,0x00,0 | PF_Valid,NULL},
    {0x3D,0x00,0 | PF_Valid,NULL},
    {0x3E,0x00,0 | PF_Operand," vpcmpub/w Vk,Hk,Wx,Ib (66),(ev)"},
    {0x3F,0x00,0 | PF_Operand," vpcmpb/w Vk,Hk,Wx,Ib (66),(ev)"},
    ...
    {0x43,0x00,0 | PF_Operand," vshufi32x4/64x2 Vx,Hx,Wx,Ib (66),(ev)"},
    {0x44,0x00,0 | PF_Operand," vpclmulqdq Vx,Hx,Wx,Ib (66)"},
    {0x45,0x00,0 | PF_Valid,NULL},
    {0x46,0x00,0 | PF_Operand," vperm2i128 Vqq,Hqq,Wqq,Ib (66),(v)"},
    {0x47,0x00,0 | PF_Valid,NULL},
    {0x48,0x00,0 | PF_Valid,NULL},
    {0x49,0x00,0 | PF_Valid,NULL},
    {0x4A,0x00,0 | PF_Operand," vblendvps Vx,Hx,Wx,Lx (66),(v)"},
    {0x4B,0x00,0 | PF_Operand," vblendvpd Vx,Hx,Wx,Lx (66),(v)"},
    {0x4C,0x00,0 | PF_Operand," vpblendvb Vx,Hx,Wx,Lx (66),(v)"},
    {0x4D,0x00,0 | PF_Valid,NULL},
    {0x4E,0x00,0 | PF_Valid,NULL},
    {0x4F,0x00,0 | PF_Valid,NULL},
    {0x50,0x00,0 | PF_Operand," vrangeps/d Vx,Hx,Wx,Ib (66),(ev)"},
    {0x51,0x00,0 | PF_Operand," vrangess/d Vx,Hx,Wx,Ib (66),(ev)"},
    {0x52,0x00,0 | PF_Valid,NULL},
    {0x53,0x00,0 | PF_Valid,NULL},
    {0x54,0x00,0 | PF_Operand," vfixupimmps/d Vx,Hx,Wx,Ib (66),(ev)"},
    {0x55,0x00,0 | PF_Operand," vfixupimmss/d Vx,Hx,Wx,Ib (66),(ev)"},
    {0x56,0x00,0 | PF_Operand," vreduceps/d Vx,Wx,Ib (66),(ev)"},
    {0x57,0x00,0 | PF_Operand," vreducess/d Vx,Hx,Wx,Ib (66),(ev)"},
    ...
    {0x5E,0x00,0 | PF_Valid,NULL},
    {0x5F,0x00,0 | PF_Valid,NULL},
    {0x60,0x00,0 | PF_Operand," vpcmpestrm Vdq,Wdq,Ib (66),(v1)"},
    {0x61,0x00,0 | PF_Operand," vpcmpestri Vdq,Wdq,Ib (66),(v1)"},
    {0x62,0x00,0 | PF_Operand," vpcmpistrm Vdq,Wdq,Ib (66),(v1)"},
    {0x63,0x00,0 | PF_Operand," vpcmpistri Vdq,Wdq,Ib (66),(v1)"},
    {0x64,0x00,0 | PF_Valid,NULL},
    {0x65,0x00,0 | PF_Valid,NULL},
    {0x66,0x00,0 | PF_Operand," vfpclassps/d Vk,Wx,Ib (66),(ev)"},
    {0x67,0x00,0 | PF_Operand," vfpclassss/d Vk,Wx,Ib (66),(ev)"},
    ...
    {0x6E,0x00,0 | PF_Valid,NULL},
    {0x6F,0x00,0 | PF_Valid,NULL},
    {0x70,0x00,0 | PF_Operand," vpshldw Vx,Hx,Wx,Ib (66),(ev)"},
    {0x71,0x00,0 | PF_Operand," vpshldd/q Vx,Hx,Wx,Ib (66),(ev)"},
    {0x72,0x00,0 | PF_Operand," vpshrdw Vx,Hx,Wx,Ib (66),(ev)"},
    {0x73,0x00,0 | PF_Operand," vpshrdd/q Vx,Hx,Wx,Ib (66),(ev)"},
    {0x74,0x00,0 | PF_Valid,NULL},
    ...
    {0xCC,0x00,0," sha1rnds4 Vdq,Wdq,Ib"},
    {0xCD,0x00,0 | PF_Valid,NULL},
    {0xCE,0x00,0 | PF_Operand," vgf2p8affineqb Vx,Wx,Ib (66)"},
    {0xCF,0x00,0 | PF_Operand," vgf2p8affineinvqb Vx,Wx,Ib (66)"},
    {0xD0,0x00,0 | PF_Valid,NULL},
    {0xD1,0x00,0 | PF_Valid,NULL},
    {0xD2,0x00,0 | PF_Valid,NULL},
    {0xD3,0x00,0 | PF_Valid,NULL},
    ...
    {0xDF,0x00,0 | PF_Operand," vaeskeygen Vdq,Wdq,Ib (66),(v1)"},
    {0xE0,0x00,0 | PF_Valid,NULL},
    {0xE1,0x00,0 | PF_Valid,NULL},
    {0xE2,0x00,0 | PF_Valid,NULL},
    {0xE3,0x00,0 | PF_Valid,NULL},
    ...
    {0xEE,0x00,0 | PF_Valid,NULL},
    {0xEF,0x00,0 | PF_Valid,NULL},
    {0xF0,0x00,0 | PF_REPNE," RORX Gy,Ey,Ib (F2),(v)"},
...
OP_ENTRY Grp07_01h[8] = {
    {0x01,0x80,0," SGDT Ms | VMCALL (001),(11B) | VMLAUNCH (010),(11B) | VMRESUME (011),(11B) | VMXOFF (100),(11B) | PCONFIG (101),(11B) | ENCLV "},
    ...
    {0x01,0xC3,0 | PF_Valid," LIDT Ms"},
    {0x01,0x84,0 | PF_Valid," SMSW Rv/Mw"},
...
OP_ENTRY Grp13_72h[8] = {
    {0x72,0x80,0 | PF_Operand," vprord/q Hx,Wx,Ib (66),(ev)"},
    {0x72,0x81,0 | PF_Operand," vprold/q Hx,Wx,Ib (66),(ev)"},
...
OP_ENTRY Grp14_73h[8] = {
    ...
    {0x73,0xA3,0 | PF_Valid | PF_Operand," vpsrldq Hx,Ux,Ib (66),(11B),(v1)"},
    {0x73,0x84,0 | PF_Valid,NULL},
    {0x73,0x85,0 | PF_Valid,NULL},
    {0x73,0x86,0," psllq Nq,Ib (11B) | vpsllq Hx,Ux,Ib (66),(11B),(v1)"},
    {0x73,0xA7,0 | PF_Valid | PF_Operand," vpslldq Hx,Ux,Ib (66),(11B),(v1)"},
};
...
OP_ENTRY Grp17_F3h[8] = {
    ...
    {0xF3,0x81,0," BLSR By,Ey (v)"},
    {0xF3,0x82,0," BLSMSK By,Ey (v)"},
    {0xF3,0x83,0," BLSI By,Ey (v)"},
...
OP_ENTRY Grp18_C6h[8] = {
    ...
    {0xC6,0x81,0 | PF_Operand," vgatherpf0dps/d Wx (66),(ev)"},
    {0xC6,0x82,0 | PF_Operand," vgatherpf1dps/d Wx (66),(ev)"},
    {0xC6,0x83,0 | PF_Valid,NULL},
    {0xC6,0x84,0 | PF_Valid,NULL},
    {0xC6,0x85,0 | PF_Operand," vscatterpf0dps/d Wx (66),(ev)"},
    {0xC6,0x86,0 | PF_Operand," vscatterpf1dps/d Wx (66),(ev)"},
    {0xC6,0x87,0 | PF_Valid,NULL},
};
OP_ENTRY Grp19_C7h[8] = {
    {0xC7,0x80,0 | PF_Valid,NULL},
    {0xC7,0x81,0 | PF_Operand," vgatherpf0qps/d Wx (66),(ev)"},
    {0xC7,0x82,0 | PF_Operand," vgatherpf1qps/d Wx (66),(ev)"},
    {0xC7,0x83,0 | PF_Valid,NULL},
    {0xC7,0x84,0 | PF_Valid,NULL},
    {0xC7,0x85,0 | PF_Operand," vscatterpf0qps/d Wx (66),(ev)"},
    {0xC7,0x86,0 | PF_Operand," vscatterpf1qps/d Wx (66),(ev)"},
    {0xC7,0x87,0 | PF_Valid,NULL},
};
OP_ENTRY Grp20_1Ch[8] = {
    {0x1C,0x80,0," cldemote Mb"},
...
OP_ENTRY Grp21_1Eh[8] = {
    ...
    {0x1E,0xA1,0 | PF_REP," RDSSPD/Q Ry (F3),(11B)"},
...
OP_ENTRY GrpRNG_A7h[8] = {
    {0xA7,0x80,0," xstore-rng"},
    {0xA7,0x81,0," xcrypt-ecb"},
    {0xA7,0x82,0," xcrypt-cbc"},
    {0xA7,0x84,0," xcrypt-cfb"},
    {0xA7,0x85,0," xcrypt-ofb"},
...
OP_ENTRY OP_62[2] = {
    {0x62,0x40,0 | PF_Valid," BOUND Gv,Ma (i64)"},
...
OP_ENTRY OP_90[3] = {
    ...
    {0x90,0x00,0 | PF_Valid," XCHG rAX,rAX/r08"},
};
OP_ENTRY OP_C4[2] = {
    {0xc4,0x40,0 | PF_Valid," LES Gz,Mp (i64)"},
    {0xc4,0x00,0," VEX+2byte (Prefix)"},
};
OP_ENTRY OP_C5[2] = {
    {0xc5,0x40,0 | PF_Valid," LDS Gz,Mp (i64)"},
...
OP_ENTRY OP_0F09[2] = {
    ...
    {0x09,0x00,0 | PF_REP," WBNOINVD (F3)"},
};
OP_ENTRY OP_0F10[4] = {
...
OP_ENTRY OP_0F12[5] = {
    {0x12,0x40,0 | PF_Valid," vmovlps Vq,Hq,Mq (v1)"},
    {0x12,0x20,0 | PF_Valid," vmovhlps Vq,Hq,Uq (v1)"},
    {0x12,0x40,0 | PF_Valid | PF_Operand," vmovlpd Vq,Hq,Mq (66),(v1)"},
    {0x12,0x00,0 | PF_Valid | PF_REP," vmovsldup Vx,Wx (F3)"},
    {0x12,0x00,0 | PF_Valid | PF_REPNE," vmovddup Vx,Wx (F2)"},
};
OP_ENTRY OP_0F13[2] = {
    {0x13,0x40,0 | PF_Valid," vmovlps Mq,Vq (v1)"},
    {0x13,0x40,0 | PF_Valid | PF_Operand," vmovlpd Mq,Vq (66),(v1)"},
};
OP_ENTRY OP_0F14[2] = {
...
OP_ENTRY OP_0F16[4] = {
    {0x16,0x40,0 | PF_Valid," vmovhps Vdq,Hq,Mq (v1)"},
    {0x16,0x20,0 | PF_Valid," vmovlhps Vdq,Hq,Uq (v1)"},
    {0x16,0x40,0 | PF_Valid | PF_Operand," vmovhpd Vdq,Hq,Mq (66),(v1)"},
    {0x16,0x00,0 | PF_Valid | PF_REP," vmovshdup Vx,Wx (F3)"},
};
OP_ENTRY OP_0F17[2] = {
    {0x17,0x40,0 | PF_Valid," vmovhps Mq,Vq (v1)"},
    {0x17,0x40,0 | PF_Valid | PF_Operand," vmovhpd Mq,Vq (66),(v1)"},
};
OP_ENTRY OP_0F1A[4] = {
    {0x1a,0x00,0 | PF_REP," BNDCL Gv,Ev (F3)"},
    {0x1a,0x00,0 | PF_REPNE," BNDCU Gv,Ev (F2)"},
    {0x1a,0x00,0 | PF_Operand," BNDMOV Gv,Ev (66)"},
    {0x1a,0x00,0," BNDLDX Gv,Ev"},
};
OP_ENTRY OP_0F1B[4] = {
    {0x1b,0x00,0 | PF_REPNE," BNDCN Gv,Ev (F2)"},
    {0x1b,0x00,0 | PF_Operand," BNDMOV Ev,Gv (66)"},
    {0x1b,0x00,0 | PF_REP," BNDMK Gv,Ev (F3)"},
    {0x1b,0x00,0," BNDSTX Ev,Gv"},
};
OP_ENTRY OP_0F28[2] = {
...
OP_ENTRY OP_0F2B[2] = {
    {0x2b,0x40,0 | PF_Valid," vmovntps Mps,Vps"},
    {0x2b,0x40,0 | PF_Valid | PF_Operand," vmovntpd Mpd,Vpd (66)"},
};
OP_ENTRY OP_0F2C[4] = {
...
OP_ENTRY OP_0F41[3] = {
    ...
    {0x41,0x20,0," kandw/q Vk,Hk,Uk"},
    {0x41,0x20,0 | PF_Operand," kandb/d Vk,Hk,Uk (66)"},
};
OP_ENTRY OP_0F42[3] = {
    {0x42,0x00,0 | PF_Valid," CMOVB/C/NAE Gv,Ev"},
    {0x42,0x20,0," kandnw/q Vk,Hk,Uk"},
    {0x42,0x20,0 | PF_Operand," kandnb/d Vk,Hk,Uk (66)"},
};
OP_ENTRY OP_0F44[3] = {
    {0x44,0x00,0 | PF_Valid," CMOVE/Z Gv,Ev"},
    {0x44,0x20,0," knotw/q Vk,Uk"},
    {0x44,0x20,0 | PF_Operand," knotb/d Vk,Uk (66)"},
};
OP_ENTRY OP_0F45[3] = {
    {0x45,0x00,0 | PF_Valid," CMOVNE/NZ Gv,Ev"},
    {0x45,0x20,0," korw/q Vk,Hk,Uk"},
    {0x45,0x20,0 | PF_Operand," korb/d Vk,Hk,Uk (66)"},
};
OP_ENTRY OP_0F46[3] = {
    {0x46,0x00,0 | PF_Valid," CMOVBE/NA Gv,Ev"},
    {0x46,0x20,0," kxnorw/q Vk,Hk,Uk"},
    {0x46,0x20,0 | PF_Operand," kxnorb/d Vk,Hk,Uk (66)"},
};
OP_ENTRY OP_0F47[3] = {
    {0x47,0x00,0 | PF_Valid," CMOVA/NBE Gv,Ev"},
    {0x47,0x20,0," kxorw/q Vk,Hk,Uk"},
    {0x47,0x20,0 | PF_Operand," kxorb/d Vk,Hk,Uk (66)"},
};
OP_ENTRY OP_0F4A[3] = {
    {0x4a,0x00,0 | PF_Valid," CMOVP/PE Gv,Ev"},
    {0x4a,0x20,0," kaddw/q Vk,Hk,Uk"},
    {0x4a,0x20,0 | PF_Operand," kaddb/d Vk,Hk,Uk (66)"},
};
OP_ENTRY OP_0F4B[3] = {
    {0x4b,0x00,0 | PF_Valid," CMOVNP/PO Gv,Ev"},
    {0x4b,0x20,0 | PF_Operand," kunpckbw Vk,Hk,Uk (66)"},
    {0x4b,0x20,0," kunpckwd/dq Vk,Hk,Uk"},
};
OP_ENTRY OP_0F50[2] = {
    {0x50,0x20,0 | PF_Valid," vmovmskps Gy,Ups"},
    {0x50,0x20,0 | PF_Valid | PF_Operand," vmovmskpd Gy,Upd (66)"},
};
OP_ENTRY OP_0F51[4] = {
...
OP_ENTRY OP_0F90[3] = {
    ...
    {0x90,0x00,0," kmovw/q Vk,Wk"},
    {0x90,0x00,0 | PF_Operand," kmovb/d Vk,Wk (66)"},
};
OP_ENTRY OP_0F91[3] = {
    {0x91,0x00,0 | PF_Valid," SETNO Eb"},
    {0x91,0x40,0," kmovw/q Mv,Vk"},
    {0x91,0x40,0 | PF_Operand," kmovb/d Mv,Vk (66)"},
};
OP_ENTRY OP_0F92[4] = {
    {0x92,0x00,0 | PF_Valid," SETB/C/NAE Eb"},
    {0x92,0x20,0," kmovw Vk,Rv"},
    {0x92,0x20,0 | PF_Operand," kmovb Vk,Rv (66)"},
    {0x92,0x20,0 | PF_REPNE," kmovq/d Vk,Rv (F2)"},
};
OP_ENTRY OP_0F93[4] = {
    {0x93,0x00,0 | PF_Valid," SETAE/NB/NC Eb"},
    {0x93,0x20,0," kmovw Gv,Uk"},
    {0x93,0x20,0 | PF_Operand," kmovb Gv,Uk (66)"},
    {0x93,0x20,0 | PF_REPNE," kmovq/d Gv,Uk (F2)"},
};
OP_ENTRY OP_0F98[3] = {
    {0x98,0x00,0 | PF_Valid," SETS Eb"},
    {0x98,0x20,0," kortestw/q Vk,Uk"},
    {0x98,0x20,0 | PF_Operand," kortestb/d Vk,Uk (66)"},
};
OP_ENTRY OP_0F99[3] = {
    {0x99,0x00,0 | PF_Valid," SETNS Eb"},
    {0x99,0x20,0," ktestw/q Vk,Uk"},
    {0x99,0x20,0 | PF_Operand," ktestb/d Vk,Uk (66)"},
};
OP_ENTRY OP_0FB8[2] = {
...
OP_ENTRY OP_0FC5[2] = {
    {0xc5,0x20,0 | PF_Valid," pextrw Gd,Nq,Ib"},
    {0xc5,0x20,0 | PF_Valid | PF_Operand," vpextrw Gd,Udq,Ib (66),(v1)"},
};
OP_ENTRY OP_0FC6[2] = {
...
OP_ENTRY OP_0FD6[3] = {
    ...
    {0xd6,0x20,0 | PF_Valid | PF_REP," movq2dq Vdq,Nq (F3)"},
    {0xd6,0x20,0 | PF_Valid | PF_REPNE," movdq2q Pq,Uq (F2)"},
};
OP_ENTRY OP_0FD7[2] = {
    {0xd7,0x20,0 | PF_Valid," pmovmskb Gd,Nq"},
    {0xd7,0x20,0 | PF_Valid | PF_Operand," vpmovmskb Gd,Ux (66),(v1)"},
};
OP_ENTRY OP_0FD8[2] = {
...
OP_ENTRY OP_0FE7[2] = {
    {0xe7,0x40,0 | PF_Valid," movntq Mq,Pq"},
    {0xe7,0x40,0 | PF_Valid | PF_Operand," vmovntdq Mx,Vx (66)"},
};
OP_ENTRY OP_0FE8[2] = {
...
OP_ENTRY OP_0FF7[2] = {
    {0xf7,0x20,0 | PF_Valid," maskmovq Pq,Nq"},
    {0xf7,0x20,0 | PF_Valid | PF_Operand," vmaskmovdqu Vx,Ux (66),(v1)"},
};
OP_ENTRY OP_0FF8[2] = {
...
OP_ENTRY OP_0F381A[2] = {
    {0x1a,0x40,0 | PF_Operand," vbroadcastf128 Vqq,Mdq (66),(v)"},
...
OP_ENTRY OP_0F3828[2] = {
    ...
    {0x28,0x20,0 | PF_REP," vpmovm2b/w Vx,Uk (F3),(ev)"},
};
OP_ENTRY OP_0F3829[2] = {
    {0x29,0x00,0 | PF_Valid | PF_Operand," vpcmpeqq Vx,Hx,Wx (66),(v1)"},
    {0x29,0x20,0 | PF_REP," vpmovb2m/w2m Vk,Ux (F3),(ev)"},
};
OP_ENTRY OP_0F382A[2] = {
    {0x2a,0x40,0 | PF_Valid | PF_Operand," vmovntdqa Vx,Mx (66),(v1)"},
    {0x2a,0x20,0 | PF_REP," vpbroadcastmb2q Vx,Uk (F3),(ev)"},
};
OP_ENTRY OP_0F382C[2] = {
    {0x2c,0x40,0 | PF_Operand," vmaskmovps Vx,Hx,Mx (66),(v)"},
    {0x2c,0x00,0 | PF_Operand," vscalefps/d Vx,Hx,Wx (66),(evo)"},
};
OP_ENTRY OP_0F382D[2] = {
    {0x2d,0x40,0 | PF_Operand," vmaskmovpd Vx,Hx,Mx (66),(v)"},
...
OP_ENTRY OP_0F3838[2] = {
    ...
    {0x38,0x20,0 | PF_REP," vpmovm2d/q Vx,Uk (F3),(ev)"},
};
OP_ENTRY OP_0F3839[3] = {
    ...
    {0x39,0x20,0 | PF_REP," vpmovd2m/q2m Vk,Ux (F3),(ev)"},
};
OP_ENTRY OP_0F383A[2] = {
    {0x3a,0x00,0 | PF_Valid | PF_Operand," vpminuw Vx,Hx,Wx (66),(v1)"},
    {0x3a,0x20,0 | PF_REP," vpbroadcastmw2d Vx,Uk (F3),(ev)"},
};
...
OP_ENTRY OP_0F385A[2] = {
    {0x5a,0x40,0 | PF_Operand," vbroadcasti128 Vqq,Mdq (66),(v)"},
...
OP_ENTRY OP_0F38C8[2] = {
    {0xc8,0x00,0," sha1nexte Vdq,Wdq"},
    {0xc8,0x00,0 | PF_Operand," vexp2ps/d Vx,Wx (66),(ev)"},
};
OP_ENTRY OP_0F38CA[2] = {
    {0xca,0x00,0," sha1msg2 Vdq,Wdq"},
    {0xca,0x00,0 | PF_Operand," vrcp28ps/d Vx,Wx (66),(ev)"},
};
OP_ENTRY OP_0F38CB[2] = {
    {0xcb,0x00,0," sha256rnds2 Vdq,Wdq"},
    {0xcb,0x00,0 | PF_Operand," vrcp28ss/d Vx,Hx,Wx (66),(ev)"},
};
OP_ENTRY OP_0F38CC[2] = {
    {0xcc,0x00,0," sha256msg1 Vdq,Wdq"},
    {0xcc,0x00,0 | PF_Operand," vrsqrt28ps/d Vx,Wx (66),(ev)"},
};
OP_ENTRY OP_0F38CD[2] = {
    {0xcd,0x00,0," sha256msg2 Vdq,Wdq"},
    {0xcd,0x00,0 | PF_Operand," vrsqrt28ss/d Vx,Hx,Wx (66),(ev)"},
};
OP_ENTRY OP_0F38F0[4] = {
    {0xf0,0x40,0," MOVBE Gy,My"},
    {0xf0,0x40,0 | PF_Operand," MOVBE Gw,Mw (66)"},
    {0xf0,0x00,0 | PF_REPNE," CRC32 Gd,Eb (F2)"},
    {0xf0,0x00,0 | PF_Operand | PF_REPNE," CRC32 Gd,Eb (66&F2)"},
};
OP_ENTRY OP_0F38F1[4] = {
    {0xf1,0x40,0," MOVBE My,Gy"},
    {0xf1,0x40,0 | PF_Operand," MOVBE Mw,Gw (66)"},
    {0xf1,0x00,0 | PF_REPNE," CRC32 Gd,Ey (F2)"},
    {0xf1,0x00,0 | PF_Operand | PF_REPNE," CRC32 Gd,Ew (66&F2)"},
};
OP_ENTRY OP_0F38F5[4] = {
    ...
    {0xf5,0x40,0 | PF_Operand," WRUSSD/Q My,Gy (66)"},
};
OP_ENTRY OP_0F38F6[4] = {
    {0xf6,0x00,0 | PF_Operand," ADCX Gy,Ey (66)"},
    {0xf6,0x00,0 | PF_REP," ADOX Gy,Ey (F3)"},
    {0xf6,0x00,0 | PF_REPNE," MULX By,Gy,rDX,Ey (F2),(v)"},
    {0xf6,0x40,0," WRSSD/Q My,Gy"},
};
...
OP_ENTRY OP_0F38F8[2] = {
    {0xf8,0x40,0 | PF_REPNE," ENQCMD Gv,Mdqq (F2)"},
    {0xf8,0x40,0 | PF_REP," ENQCMDS Gv,Mdqq (F3)"},
};
...
OP_ENTRY OP_0F01_0[7] = {
    {0x01,0xC0,0 | PF_Valid," SGDT Ms"},
    {0x01,0xA0,0," VMCALL (001),(11B)"},
    {0x01,0xA0,0," VMLAUNCH (010),(11B)"},
    {0x01,0xA0,0," VMRESUME (011),(11B)"},
    {0x01,0xA0,0," VMXOFF (100),(11B)"},
    {0x01,0xA0,0," PCONFIG (101),(11B)"},
    {0x01,0xA0,0," ENCLV (000),(11B)"},
};
OP_ENTRY OP_0F01_1[6] = {
    {0x01,0xC1,0 | PF_Valid," SIDT Ms"},
    {0x01,0xA1,0 | PF_Valid | PF_Uncertain," MONITOR (000),(11B)"},
    {0x01,0xA1,0 | PF_Valid | PF_Uncertain," MWAIT (001),(11B)"},
    {0x01,0xA1,0," CLAC (010),(11B)"},
    {0x01,0xA1,0," STAC (011),(11B)"},
    {0x01,0xA1,0," ENCLS (111),(11B)"},
};
OP_ENTRY OP_0F01_2[7] = {
    {0x01,0xC2,0 | PF_Valid," LGDT Ms"},
    {0x01,0xA2,0 | PF_Valid | PF_Uncertain," XGETBV (000),(11B)"},
    {0x01,0xA2,0 | PF_Valid | PF_Uncertain," XSETBV (001),(11B)"},
    {0x01,0xA2,0," VMFUNC (100),(11B)"},
    {0x01,0xA2,0," XEND (101)(11B)"},
    {0x01,0xA2,0," XTEST (110)(11B)"},
    {0x01,0xA2,0," ENCLU (111),(11B)"},
};
OP_ENTRY OP_0F01_5[5] = {
    {0x01,0xA5,0," rdpkru (110),(11B)"},
    {0x01,0xA5,0," wrpkru (111),(11B)"},
    {0x01,0xA5,0 | PF_REP," SAVEPREVSSP (F3),(010),(11B)"},
    {0x01,0xC5,0 | PF_REP," RSTORSSP Mq (F3)"},
    {0x01,0xA5,0 | PF_REP," SETSSBSY (F3),(000),(11B)"},
};
OP_ENTRY OP_0F01_7[3] = {
    {0x01,0xC7,0 | PF_Valid," INVLPG Mb"},
    {0x01,0xA7,0," SWAPGS (o64),(000),(11B)"},
    {0x01,0xA7,0 | PF_Valid | PF_Uncertain," RDTSCP (001),(11B)"},
};
// Grp09_0FC7
OP_ENTRY OP_0FC7_6[4] = {
    {0xc7,0xC6,0," VMPTRLD Mq"},
    {0xc7,0xC6,0 | PF_Operand," VMCLEAR Mq (66)"},
    {0xc7,0xC6,0 | PF_REP," VMXON Mq (F3)"},
    {0xc7,0xA6,0," RDRAND Rv (11B)"},
};
OP_ENTRY OP_0FC7_7[3] = {
    {0xc7,0xC7,0," VMPTRST Mq"},
    {0xc7,0xC7,0 | PF_REP," VMPTRST Mq (F3)"},
    {0xc7,0xA7,0," RDSEED Rv (11B)"},
};
// Grp12_0F71
OP_ENTRY OP_0F71_2[2] = {
    {0x71,0xA2,0 | PF_Valid," psrlw Nq,Ib (11B)"},
    {0x71,0xA2,0 | PF_Valid | PF_Operand," vpsrlw Hx,Ux,Ib (66),(11B),(v1)"},
};
OP_ENTRY OP_0F71_4[2] = {
    {0x71,0xA4,0 | PF_Valid," psraw Nq,Ib (11B)"},
    {0x71,0xA4,0 | PF_Valid | PF_Operand," vpsraw Hx,Ux,Ib (66),(11B),(v1)"},
};
OP_ENTRY OP_0F71_6[2] = {
    {0x71,0xA6,0 | PF_Valid," psllw Nq,Ib (11B)"},
    {0x71,0xA6,0 | PF_Valid | PF_Operand," vpsllw Hx,Ux,Ib (66),(11B),(v1)"},
};
// Grp13_0F72
OP_ENTRY OP_0F72_2[2] = {
    {0x72,0xA2,0 | PF_Valid," psrld Nq,Ib (11B)"},
    {0x72,0xA2,0 | PF_Valid | PF_Operand," vpsrld Hx,Ux,Ib (66),(11B),(v1)"},
};
OP_ENTRY OP_0F72_4[3] = {
    {0x72,0xA4,0 | PF_Valid," psrad Nq,Ib (11B)"},
    {0x72,0xA4,0 | PF_Valid | PF_Operand," vpsrad Hx,Ux,Ib (66),(11B),(v1)"},
    {0x72,0xA4,0 | PF_Operand," vpsrad/q Hx,Ux,Ib (66),(evo)"},
};
OP_ENTRY OP_0F72_6[2] = {
    {0x72,0xA6,0 | PF_Valid," pslld Nq,Ib (11B)"},
    {0x72,0xA6,0 | PF_Valid | PF_Operand," vpslld Hx,Ux,Ib (66),(11B),(v1)"},
};
// Grp14_0F73
OP_ENTRY OP_0F73_2[2] = {
    {0x73,0xA2,0 | PF_Valid," psrlq Nq,Ib (11B)"},
    {0x73,0xA2,0 | PF_Valid | PF_Operand," vpsrlq Hx,Ux,Ib (66),(11B),(v1)"},
};
OP_ENTRY OP_0F73_6[2] = {
    {0x73,0xA6,0 | PF_Valid," psllq Nq,Ib (11B)"},
    {0x73,0xA6,0 | PF_Valid | PF_Operand," vpsllq Hx,Ux,Ib (66),(11B),(v1)"},
};
// Grp15_0FAE
OP_ENTRY OP_0FAE_0[2] = {
    {0xae,0xC0,0 | PF_Valid," fxsave M"},
    {0xae,0xA0,0 | PF_REP," RDFSBASE Ry (F3),(11B)"},
};
OP_ENTRY OP_0FAE_1[2] = {
    {0xae,0xC1,0 | PF_Valid," fxrstor M"},
    {0xae,0xA1,0 | PF_REP," RDGSBASE Ry (F3),(11B)"},
};
OP_ENTRY OP_0FAE_2[2] = {
    {0xae,0xC2,0 | PF_Valid," vldmxcsr Md (v1)"},
    {0xae,0xA2,0 | PF_REP," WRFSBASE Ry (F3),(11B)"},
};
OP_ENTRY OP_0FAE_3[2] = {
    {0xae,0xC3,0 | PF_Valid," vstmxcsr Md (v1)"},
    {0xae,0xA3,0 | PF_REP," WRGSBASE Ry (F3),(11B)"},
};
OP_ENTRY OP_0FAE_4[2] = {
    {0xae,0xC4,0 | PF_Valid | PF_Uncertain," XSAVE M"},
    {0xae,0xA4,0 | PF_REP," ptwrite Ey (F3),(11B)"},
};
OP_ENTRY OP_0FAE_5[3] = {
    {0xae,0xC5,0 | PF_Valid | PF_Uncertain," XRSTOR M"},
    {0xae,0xA5,0 | PF_Valid | PF_Uncertain," lfence (11B)"},
    {0xae,0xA5,0 | PF_REP," INCSSPD/Q Ry (F3),(11B)"},
};
OP_ENTRY OP_0FAE_6[7] = {
    {0xae,0xC6,0 | PF_Valid | PF_Uncertain," XSAVEOPT M"},
    {0xae,0xC6,0 | PF_Operand," clwb Mb (66)"},
    {0xae,0xA6,0 | PF_Valid," mfence (11B)"},
    {0xae,0xA6,0 | PF_Operand," TPAUSE Rd (66),(11B)"},
    {0xae,0xA6,0 | PF_REP," UMONITOR Rv (F3),(11B)"},
    {0xae,0xA6,0 | PF_REPNE," UMWAIT Rd (F2),(11B)"},
    {0xae,0xC6,0 | PF_REP," CLRSSBSY Mq (F3)"},
};
OP_ENTRY OP_0FAE_7[3] = {
    {0xae,0xC7,0 | PF_Valid | PF_Uncertain," clflush Mb"},
    {0xae,0xC7,0 | PF_Operand," clflushopt Mb (66)"},
    {0xae,0xA7,0 | PF_Valid | PF_Uncertain," sfence (11B)"},
};
// Grp21_0F1E
OP_ENTRY OP_0F1E_7[2] = {
    {0x1e,0xA7,0 | PF_REP," ENDBR64 (F3),(010),(11B)"},
    {0x1e,0xA7,0 | PF_REP," ENDBR32 (F3),(011),(11B)"},
};
